  ...
  <Fade up>
    <Cont className="vh-100 flex-column d-flex justify-content-center text-center">
      <Row className="h-25 mb-4">
        ...
        <Col>
          <CashStack  size={35} className="m-3" />
      ...
      <Row className="h-25 mb-4">
        <Col>
          <CalendarCheckFill  size={35} className="m-3" />
        ...
        <Col>
          <PeopleFill   size={35} className="m-3"/> 
        ...
        <Col>
          <CardChecklist  size={35} className="m-3" />
